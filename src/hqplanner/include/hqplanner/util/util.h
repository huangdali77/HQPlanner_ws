#ifndef HQPLANNER_UTIL_UTIL_H_
#define HQPLANNER_UTIL_UTIL_H_
 ...
 */
hqplanner::forproto::SLPoint MakeSLPoint(const double s, const double l);

template <typename T>
hqplanner::math::Vec2d MakeVec2d(const T& t) {
  return hqplanner::math::Vec2d(t.x(), t.y());
}
...
hqplanner::forproto::SpeedPoint MakeSpeedPoint(const double s, const double t,
                                               const double v, const double a,
                                               const double da);

hqplanner::forproto::PathPoint MakePathPoint(const double x, const double y,
...
//  * @return sqrt((u.x-v.x)^2 + (u.y-v.y)^2) < epsilon, i.e., the Euclid
//  distance
//  * on XY dimension.
//  */
// template <typename U, typename V>
...
hqplanner::forproto::PathPoint GetWeightedAverageOfTwoPathPoints(
    const hqplanner::forproto::PathPoint& p1,
    const hqplanner::forproto::PathPoint& p2, const double w1, const double w2);
