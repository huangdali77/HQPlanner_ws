...
// const double ConfigParam::FLAGS_max_stop_speed = 0.2;
// //被定义为停车的最大速度 const double
// ConfigParam::FLAGS_max_stop_distance_obstacle = 10.0; const double
// ConfigParam::FLAGS_min_stop_distance_obstacle = 6.0; const bool
// ConfigParam::FLAGS_enable_nudge_decision = true; const double
// ConfigParam::FLAGS_nudge_distance_obstacle = 0.5;
// //最大规划车速
...
class ConfigParam {
 public:
  ...
  const double FLAGS_min_stop_distance_obstacle = 6.0;
  ...
  const double FLAGS_follow_min_time_sec = 5.0;
